...
#   timestamp: 2023-01-16T13:11:19+00:00
...
class EventCreateRequest1(IterBaseModel):
    highCPU: Optional[AnyValue] = None
        ...
        example=[
            ...
            },
            {
                'lowDiskSpace': {
                    ...
                    'href': '/beta/spaces/altair/things/01FPSXTMN4CEGX09HF5RQ4RMY6/events/highCPU/01GPX7BR5X3YT5Y65ZMT24YT1N',
                }
            },
        ],
    )
