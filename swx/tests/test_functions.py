...
class TestThings(TestCase):
    def test_get_single_thing(self):
        ...
        with mock.patch("swx.functions.get_info", return_value=resp):
...
class TestProperties(TestCase):
    ...
    def test_get_property(self):
        ...
        resp.status_code = 200
        with mock.patch("swx.functions.get_info", return_value=resp):
            with mock.patch("swx.functions.generate_thing_url", return_value="https://api.swx.mock/spaces/space01/things/01FKGJCB21CSBGQW000000S1T1"):
    ...
    def test_update_property(self):
        ...
        with mock.patch("swx.functions.post_info", return_value=resp):
            with mock.patch("swx.functions.generate_thing_url", return_value="https://api.swx.mock/spaces/space01/things/01FKGJCB21CSBGQW000000S1T1"):
