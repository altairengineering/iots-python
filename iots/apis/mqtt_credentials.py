...
class MqttCredentials1(APIResource):
    ...
    def post(self, req: models.MQTTCategoryForm, **kwargs) -> Union[models.MQTTCategoryDocument, models.ErrorResponse]:
        """
    ...
    def get(self, **kwargs) -> Union[models.MQTTCategoryDocument, models.ErrorResponse]:
        """
        ...
        return self._handle_response(resp, [
            (200, "application/json", models.MQTTCategoryDocument),
            (401, "application/json", models.ErrorResponse),
            (403, "application/json", models.ErrorResponse),
        ])

    def put(self, req: models.MQTTCategoryForm, **kwargs) -> Union[models.MQTTCategoryDocument, models.ErrorResponse]:
        """
